...
# FONDO
fondo = pygame.image.load("Recursos/Fondos/fondo_negro.png")
...
enemigo_uno = Enemigo(
    (95, 63), diccionario_animaciones['oso'],
    {"x": ANCHO_PANTALLA/2+100, "y": ALTO_PANTALLA-50-ALTO_PISO},
    1000, 100, plataformas[0],
...
nivel_uno = Nivel(fondo, plataformas, enemigos, items)
